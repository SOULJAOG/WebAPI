...
namespace CompanyEmployess.Migrations
{
    public partial class CreatingIdentityTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Order",
                columns: new[] { "OrderId", "CustomerName", "DateOfDelivery", "DateOfIssue", "Phone" },
                values: new object[,]
                {
                    { new Guid("021ca3c1-0deb-4afd-ae94-2159a8479811"), "Nill", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "89278876345" },
                    { new Guid("80abbca8-664d-4b20-b5de-024715497d4a"), "Raiden", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "89278976365" },
                    { new Guid("86dba8c0-d178-41e7-938c-ed49778fb52a"), "Miller", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "89278876365" }
                });
